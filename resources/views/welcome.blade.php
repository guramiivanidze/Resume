        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    @if($experiance->type === 'sumary')
                    <div class="resume-item pb-0">
                        <h4><?php echo $experiance->title?></h4>
                        <p><em><?php echo $experiance->teaser?></em></p>
                        <ul>
                            <?php echo $experiance->description ?>
...
{{--                            <li>alice.barkley@example.com</li>--}}
                    ...
                    <?php foreach ($experiances as $experiance): ?>
                    @if($experiance->type === 'education')
                    <div class="resume-item">
                        <h4><?php echo $experiance->title?></h4>
                        <h5><?php echo $experiance->teaser_date?></h5>
                        <p><em><?php echo $experiance->teaser?></em></p>
